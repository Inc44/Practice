		...
		<div class="flex h-full max-h-full flex-col">
			...
			<div class="h-full overflow-y-auto">
				<ul class="accordion menu menu-sm gap-1 p-3">
					<!-- Dashboard Menu Item -->
					<li>
						<a href="{{ route('dashboard') }}" @class(['inline-flex w-full items-center px-2', 'menu-active'=> request()->routeIs('dashboard')])> <span class="icon-[tabler--dashboard] size-4.5"></span>
					...
					<li @class(['accordion-item', 'active'=> request()->routeIs('users.*')]) id="user-management"> <button class="accordion-toggle accordion-item-active:bg-neutral/10 inline-flex w-full items-center p-2 text-start text-sm font-normal" aria-controls="user-management-collapse-user-management" aria-expanded="true">
						...
						<div id="user-management-collapse-user-management" class="accordion-content mt-1 hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="account-settings" role="region" @if(request()->routeIs('users.*')) style="display: block;" @endif> <ul class="space-y-1">
								<li>
									<a href="{{ route('users.index') }}" @class(['inline-flex w-full items-center px-2', 'menu-active'=> request()->routeIs('users.index')])> <span>Users</span>
									</a>
								</li>
							</ul>
						</div>
					...
					<li>
						<a href="{{ route('videos.index') }}" @class(['inline-flex w-full items-center px-2', 'menu-active'=> request()->routeIs('videos.index')])> <span class="icon-[tabler--video] size-4.5"></span>
							<span>Videos</span>
						</a>
					</li>
					<!-- Book Management Menu -->
					<li>
						<a href="{{ route('books.index') }}" @class(['inline-flex w-full items-center px-2', 'menu-active'=> request()->routeIs('books.*') || request()->routeIs('authors.*')])> <span class="icon-[tabler--book] size-4.5"></span>
							<span>Books</span>
						</a>
					</li>
				</ul>
